...
import (
	"flag"
	"fmt"
	"github.com/Hnn3435/woxuexi/utils/stop"
	"io"
	"math/rand"
	"net/http"
	"os"
	...
	// "github.com/Hnn3435/woxuexi/gui"
...
func init() {
	...
	if !utils.CheckQuestionDB() {
		...
		//log.Errorln("题库文件不存在或已损坏，请手动前往 https://github.com/Hnn3435/woxuexi/blob/main/conf/QuestionBank.db 下载并放入程序根目录")
	}
}
